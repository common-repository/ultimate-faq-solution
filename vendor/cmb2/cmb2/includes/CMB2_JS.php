...
class CMB2_JS {
	...
	protected static function colorpicker_frontend() {
		...
		wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
			'clear'         => esc_html__( 'Clear', 'ufaqsw' ),
			'defaultString' => esc_html__( 'Default', 'ufaqsw' ),
			'pick'          => esc_html__( 'Select Color', 'ufaqsw' ),
			'current'       => esc_html__( 'Current Color', 'ufaqsw' ),
		) );
	}
		...
		$l10n = array(
			...
			'defaults'          => array(
				...
				'date_picker'  => array(
					'changeMonth'     => true,
					'changeYear'      => true,
					'dateFormat'      => _x( 'mm/dd/yy', 'Valid formatDate string for jquery-ui datepicker', 'ufaqsw' ),
					'dayNames'        => explode( ',', esc_html__( 'Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday', 'ufaqsw' ) ),
					'dayNamesMin'     => explode( ',', esc_html__( 'Su, Mo, Tu, We, Th, Fr, Sa', 'ufaqsw' ) ),
					'dayNamesShort'   => explode( ',', esc_html__( 'Sun, Mon, Tue, Wed, Thu, Fri, Sat', 'ufaqsw' ) ),
					'monthNames'      => explode( ',', esc_html__( 'January, February, March, April, May, June, July, August, September, October, November, December', 'ufaqsw' ) ),
					'monthNamesShort' => explode( ',', esc_html__( 'Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec', 'ufaqsw' ) ),
					'nextText'        => esc_html__( 'Next', 'ufaqsw' ),
					'prevText'        => esc_html__( 'Prev', 'ufaqsw' ),
					'currentText'     => esc_html__( 'Today', 'ufaqsw' ),
					'closeText'       => esc_html__( 'Done', 'ufaqsw' ),
					'clearText'       => esc_html__( 'Clear', 'ufaqsw' ),
				),
				'time_picker'  => array(
					'timeOnlyTitle' => esc_html__( 'Choose Time', 'ufaqsw' ),
					'timeText'      => esc_html__( 'Time', 'ufaqsw' ),
					'hourText'      => esc_html__( 'Hour', 'ufaqsw' ),
					'minuteText'    => esc_html__( 'Minute', 'ufaqsw' ),
					'secondText'    => esc_html__( 'Second', 'ufaqsw' ),
					'currentText'   => esc_html__( 'Now', 'ufaqsw' ),
					'closeText'     => esc_html__( 'Done', 'ufaqsw' ),
					'timeFormat'    => _x( 'hh:mm TT', 'Valid formatting string, as per http://trentrichardson.com/examples/timepicker/', 'ufaqsw' ),
					'controlType'   => 'select',
					'stepMinute'    => 5,
				),
			),
			'strings' => array(
				'upload_file'  => esc_html__( 'Use this file', 'ufaqsw' ),
				'upload_files' => esc_html__( 'Use these files', 'ufaqsw' ),
				'remove_image' => esc_html__( 'Remove Image', 'ufaqsw' ),
				'remove_file'  => esc_html__( 'Remove', 'ufaqsw' ),
				'file'         => esc_html__( 'File:', 'ufaqsw' ),
				'download'     => esc_html__( 'Download', 'ufaqsw' ),
				'check_toggle' => esc_html__( 'Select / Deselect All', 'ufaqsw' ),
			),
		);
