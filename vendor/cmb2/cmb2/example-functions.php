...
function yourprefix_register_demo_metabox() {
	...
	$cmb_demo = new_cmb2_box( array(
		...
		'title'         => esc_html__( 'Test Metabox', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name'       => esc_html__( 'Test Text', 'ufaqsw' ),
		'desc'       => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Small', 'ufaqsw' ),
		'desc' => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Medium', 'ufaqsw' ),
		'desc' => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name'       => esc_html__( 'Read-only Disabled Field', 'ufaqsw' ),
		'desc'       => esc_html__( 'field description (optional)', 'ufaqsw' ),
		'id'         => 'yourprefix_demo_readonly',
		'type'       => 'text_medium',
		'default'    => esc_attr__( 'Hey there, I\'m a read-only field', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Custom Rendered Field', 'ufaqsw' ),
		'desc' => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Website URL', 'ufaqsw' ),
		'desc' => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Email', 'ufaqsw' ),
		'desc' => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Time', 'ufaqsw' ),
		'desc' => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Time zone', 'ufaqsw' ),
		'desc' => esc_html__( 'Time zone', 'ufaqsw' ),
		'id'   => 'yourprefix_demo_timezone',
		'type' => 'select_timezone',
	) );

	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Date Picker', 'ufaqsw' ),
		'desc' => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Date Picker (UNIX timestamp)', 'ufaqsw' ),
		'desc' => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Date/Time Picker Combo (UNIX timestamp)', 'ufaqsw' ),
		'desc' => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Money', 'ufaqsw' ),
		'desc' => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Test Color Picker', 'ufaqsw' ),
		'desc'    => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Area', 'ufaqsw' ),
		'desc' => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Area Small', 'ufaqsw' ),
		'desc' => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Area for Code', 'ufaqsw' ),
		'desc' => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Title Weeeee', 'ufaqsw' ),
		'desc' => esc_html__( 'This is a title description', 'ufaqsw' ),
		'id'   => 'yourprefix_demo_title',
		'type' => 'title',
	) );

	$cmb_demo->add_field( array(
		'name'             => esc_html__( 'Test Select', 'ufaqsw' ),
		'desc'             => esc_html__( 'field description (optional)', 'ufaqsw' ),
		'id'               => 'yourprefix_demo_select',
		'type'             => 'select',
		'show_option_none' => true,
		'options'          => array(
			'standard' => esc_html__( 'Option One', 'ufaqsw' ),
			'custom'   => esc_html__( 'Option Two', 'ufaqsw' ),
			'none'     => esc_html__( 'Option Three', 'ufaqsw' ),
		),
	) );

	$cmb_demo->add_field( array(
		'name'             => esc_html__( 'Test Radio inline', 'ufaqsw' ),
		'desc'             => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Test Radio', 'ufaqsw' ),
		'desc'    => esc_html__( 'field description (optional)', 'ufaqsw' ),
		'id'      => 'yourprefix_demo_radio',
		'type'    => 'radio',
		'options' => array(
			'option1' => esc_html__( 'Option One', 'ufaqsw' ),
			'option2' => esc_html__( 'Option Two', 'ufaqsw' ),
			'option3' => esc_html__( 'Option Three', 'ufaqsw' ),
		),
	) );

	$cmb_demo->add_field( array(
		'name'     => esc_html__( 'Test Taxonomy Radio', 'ufaqsw' ),
		'desc'     => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name'     => esc_html__( 'Test Taxonomy Select', 'ufaqsw' ),
		'desc'     => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name'     => esc_html__( 'Test Taxonomy Multi Checkbox', 'ufaqsw' ),
		'desc'     => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Checkbox', 'ufaqsw' ),
		'desc' => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Test Multi Checkbox', 'ufaqsw' ),
		'desc'    => esc_html__( 'field description (optional)', 'ufaqsw' ),
		'id'      => 'yourprefix_demo_multicheckbox',
		'type'    => 'multicheck',
		// 'multiple' => true, // Store values in individual rows
		'options' => array(
			'check1' => esc_html__( 'Check One', 'ufaqsw' ),
			'check2' => esc_html__( 'Check Two', 'ufaqsw' ),
			'check3' => esc_html__( 'Check Three', 'ufaqsw' ),
		),
		// 'inline'  => true, // Toggles display to inline
	) );

	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Test wysiwyg', 'ufaqsw' ),
		'desc'    => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Image', 'ufaqsw' ),
		'desc' => esc_html__( 'Upload an image or enter a URL.', 'ufaqsw' ),
		'id'   => 'yourprefix_demo_image',
		'type' => 'file',
	) );

	$cmb_demo->add_field( array(
		'name'         => esc_html__( 'Multiple Files', 'ufaqsw' ),
		'desc'         => esc_html__( 'Upload or add multiple images/attachments.', 'ufaqsw' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'oEmbed', 'ufaqsw' ),
		'desc' => sprintf(
			/* translators: %s: link to codex.wordpress.org/Embeds */
			esc_html__( 'Enter a youtube, twitter, or instagram URL. Supports services listed at %s.', 'ufaqsw' ),
...
function yourprefix_register_about_page_metabox() {
	...
	$cmb_about_page = new_cmb2_box( array(
		...
		'title'        => esc_html__( 'About Page Metabox', 'ufaqsw' ),
		'object_types' => array( 'page' ), // Post type
		'context'      => 'normal',
		'priority'     => 'high',
		'show_names'   => true, // Show field names on the left
...
function yourprefix_register_repeatable_group_field_metabox() {
	...
	$cmb_group = new_cmb2_box( array(
		...
		'title'        => esc_html__( 'Repeating Field Group', 'ufaqsw' ),
	...
	$group_field_id = $cmb_group->add_field( array(
		...
		'type'        => 'group',
		'description' => esc_html__( 'Generates reusable form entries', 'ufaqsw' ),
		'options'     => array(
			'group_title'    => esc_html__( 'Entry {#}', 'ufaqsw' ), // {#} gets replaced by row number
			'add_button'     => esc_html__( 'Add Another Entry', 'ufaqsw' ),
			'remove_button'  => esc_html__( 'Remove Entry', 'ufaqsw' ),
			'sortable'       => true,
	...
	$cmb_group->add_group_field( $group_field_id, array(
		'name'       => esc_html__( 'Entry Title', 'ufaqsw' ),
		'id'         => 'title',
		'type'       => 'text',
	...
	$cmb_group->add_group_field( $group_field_id, array(
		'name'        => esc_html__( 'Description', 'ufaqsw' ),
		'description' => esc_html__( 'Write a short description for this entry', 'ufaqsw' ),
		'id'          => 'description',
		'type'        => 'textarea_small',
	) );

	$cmb_group->add_group_field( $group_field_id, array(
		'name' => esc_html__( 'Entry Image', 'ufaqsw' ),
		'id'   => 'image',
		'type' => 'file',
	) );

	$cmb_group->add_group_field( $group_field_id, array(
		'name' => esc_html__( 'Image Caption', 'ufaqsw' ),
		'id'   => 'image_caption',
		'type' => 'text',
	) );
...
function yourprefix_register_user_profile_metabox() {
	...
	$cmb_user = new_cmb2_box( array(
		...
		'title'            => esc_html__( 'User Profile Metabox', 'ufaqsw' ), // Doesn't output for user boxes
	...
	$cmb_user->add_field( array(
		'name'     => esc_html__( 'Extra Info', 'ufaqsw' ),
		'desc'     => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_user->add_field( array(
		'name' => esc_html__( 'Facebook URL', 'ufaqsw' ),
		'desc' => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_user->add_field( array(
		'name' => esc_html__( 'Twitter URL', 'ufaqsw' ),
		'desc' => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_user->add_field( array(
		'name' => esc_html__( 'Google+ URL', 'ufaqsw' ),
		'desc' => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_user->add_field( array(
		'name' => esc_html__( 'Linkedin URL', 'ufaqsw' ),
		'desc' => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_user->add_field( array(
		'name' => esc_html__( 'User Field', 'ufaqsw' ),
		'desc' => esc_html__( 'field description (optional)', 'ufaqsw' ),
...
function yourprefix_register_taxonomy_metabox() {
	...
	$cmb_term = new_cmb2_box( array(
		...
		'title'            => esc_html__( 'Category Metabox', 'ufaqsw' ), // Doesn't output for term boxes
	...
	$cmb_term->add_field( array(
		'name' => esc_html__( 'Term Image', 'ufaqsw' ),
		'desc' => esc_html__( 'field description (optional)', 'ufaqsw' ),
	...
	$cmb_term->add_field( array(
		'name' => esc_html__( 'Arbitrary Term Field', 'ufaqsw' ),
		'desc' => esc_html__( 'field description (optional)', 'ufaqsw' ),
...
function yourprefix_register_theme_options_metabox() {
	...
	$cmb_options = new_cmb2_box( array(
		...
		'title'        => esc_html__( 'Theme Options', 'ufaqsw' ),
	...
	$cmb_options->add_field( array(
		'name'    => esc_html__( 'Site Background Color', 'ufaqsw' ),
		'desc'    => esc_html__( 'field description (optional)', 'ufaqsw' ),
		'id'      => 'bg_color',
		'type'    => 'colorpicker',
		'default' => '#ffffff',
...
function yourprefix_options_page_message_callback( $cmb, $args ) {
	if ( ! empty( $args['should_notify'] ) ) {
		...
		if ( $args['is_updated'] ) {
			...
			$args['message'] = sprintf( esc_html__( '%s &mdash; Updated!', 'ufaqsw' ), $cmb->prop( 'title' ) );
		}
...
function yourprefix_register_rest_api_box() {
	$cmb_rest = new_cmb2_box( array(
		...
		'title'         => esc_html__( 'REST Test Box', 'ufaqsw' ),
		'object_types'  => array( 'page' ), // Post type
	...
	$cmb_rest->add_field( array(
		'name'       => esc_html__( 'REST Test Text', 'ufaqsw' ),
		'desc'       => esc_html__( 'Will show in the REST API for this box and for pages.', 'ufaqsw' ),
		'id'         => 'yourprefix_rest_text',
		'type'       => 'text',
	) );

	$cmb_rest->add_field( array(
		'name'       => esc_html__( 'REST Editable Test Text', 'ufaqsw' ),
		'desc'       => esc_html__( 'Will show in REST API "editable" contexts only (`POST` requests).', 'ufaqsw' ),
